...
class TestEditor(unittest.TestCase):
	...
	def test_editor(self):
		...
		driver.find_element_by_class_name("ace_text-input").send_keys("""process a { action one{ agent {"bob"}}  action two { tool {"pen"} } }""",Keys.RETURN)
		# Draw the graph
		driver.find_element_by_id("socialNetworkButton").click()
		...
		driver.find_element_by_id("modalFullscreenChoiceNetworkButton").click()
